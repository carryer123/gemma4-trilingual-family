...
| Human-tier probe order | sorted by `id` (deterministic) |
...
| LoRA-v2 training | completed | 1× A100 |
| G2-52 16-adapter evaluation | ~15 min | 4× A100 |
| G2-52 core recheck (4 adapters) | ~2 min | 4× A100 |
...
│   ├── eval/        (baseline_via_ollama.py, lora_v1_vs_stock.py,
│   │                 auto_judge.py, eval_g2_extended.py,
│   │                 summarize_g2_extended.py,
│   │                 g2_threshold_sensitivity.py,
│   │                 export_g2_raw_generations.py)
│   └── eval/        (G2/G3 audit scripts)
├── paper/
│   ├── PAPER_OUTLINE.md
│   ├── sections/    (01–08 + appendix_A/B/D/E)
│   ├── figures/
│   │   ├── g2_extended_scores.json
│   │   ├── g2_extended_selector_table.md
│   │   ├── g2_threshold_sensitivity.md
│   │   ├── g2_extended_raw_generations.jsonl
│   │   ├── g2_recheck_raw_generations.jsonl
│   │   └── g2_recheck_comparison.md
│   └── data_release/
│       └── family_as_evaluator_probes_v1.jsonl   (30 probes)
├── lora_out/lora_v1/adapter/     (the released LoRA-v1 adapter, 259 MB)
├── lora_out/lora_v2/adapter/     (LoRA-v2 adapter)
├── models/
