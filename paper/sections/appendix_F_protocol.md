# Appendix F: Family-as-Evaluator Protocol Specification (v1)

This appendix is a copy-paste-ready specification of the FaE protocol
...
fae_preregistration:
  ...
  probe_set:
    file: family_as_evaluator_probes_v1.jsonl
...
## F.2 Probe-set construction rules
...
## F.4 Reporting standard

A FaE report includes, in order:
...
## F.5 Tier promotion rules

To upgrade a Tier 1 result to Tier 2, an FaE evaluation must satisfy:
...
## F.6 What this protocol explicitly is not

* **It is not a benchmark leaderboard.** Probes are intentionally not
...
* **It is not exclusive.** FaE is meant to *complement* automated
...
@misc{lee2026fae,
  ...
  year   = {2026},
  note   = {Appendix F of "Beyond BLEU: Trilingual L1-Aware On-Device Tutoring with Gemma 4."},
  howpublished = {\url{https://github.com/[author]/gemma4-trilingual-family/blob/main/tools/fae_protocol/SPEC.md}}
}
```
